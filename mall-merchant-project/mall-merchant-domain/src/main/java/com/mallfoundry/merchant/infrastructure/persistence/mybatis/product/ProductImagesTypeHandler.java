...
import com.mallfoundry.merchant.domain.product.ProductImage;
...
public class ProductImagesTypeHandler extends BaseTypeHandler<List<ProductImage>> {
    ...
    private List<ProductImage> getNullableResult(String value) {
        return Objects.isNull(value) ? Collections.emptyList() : JsonUtils.parse(value, List.class, ProductImage.class);
    }
}
