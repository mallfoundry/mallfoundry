...
public abstract class InventoryAdjustmentSupport implements InventoryAdjustment {
    ...
    protected abstract static class BuilderSupport implements Builder {
        ...
        protected final InventoryAdjustmentSupport adjustment;

        protected BuilderSupport(InventoryAdjustmentSupport adjustment) {
