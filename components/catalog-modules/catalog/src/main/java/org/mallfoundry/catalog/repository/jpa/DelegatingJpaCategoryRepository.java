...
public class DelegatingJpaCategoryRepository implements CategoryRepository {

    private final JpaCategoryRepository repository;

    public DelegatingJpaCategoryRepository(JpaCategoryRepository repository) {
        this.repository = repository;
    }

    @Override
    public Category save(Category category) {
        return this.repository.save(JpaCategory.of(category));
    }
    ...
    @Override
    public List<Category> findAll(CategoryQuery query) {
        return CastUtils.cast(this.repository.findAll(query));
    }

    @Override
    public void delete(Category category) {
        this.repository.delete(JpaCategory.of(category));
    }
}
