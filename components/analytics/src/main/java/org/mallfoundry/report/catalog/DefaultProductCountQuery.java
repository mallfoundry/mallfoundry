...
@Getter
@Setter
public class DefaultProductCountQuery implements ProductCountQuery {
    ...
    protected abstract static class BuilderSupport implements Builder {
        ...
        private final DefaultProductCountQuery query;

        protected BuilderSupport(DefaultProductCountQuery query) {
            this.query = query;
        }
