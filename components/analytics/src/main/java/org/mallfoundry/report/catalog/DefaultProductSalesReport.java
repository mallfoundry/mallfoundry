...
public class DefaultProductSalesReport implements ProductSalesReport {

    private final ProductSalesReportRepository productSalesReportRepository;

    public DefaultProductSalesReport(ProductSalesReportRepository productSalesReportRepository) {
    ...
    public SliceList<ProductSale> queryProductSales(ProductSalesQuery query) {
        return this.productSalesReportRepository.queryProductSales(query);
    }
}
