...
@StandaloneTest
public class DefaultDateDimensionManagerTests {
    ...
    public void testSaveFrom20200101To20251231() {
        ...
        while (startDate.isBefore(endDate)) {
            ...
            var dateDimension = this.dateDimensionManager.createDateDimension(Date.from(instant));
            this.dateDimensionManager.saveDateDimension(dateDimension);
