...
@Getter
@Setter
public class DefaultProductSalesQuery implements ProductSalesQuery {
    ...
    protected abstract static class BuilderSupport implements Builder {
        ...
        protected BuilderSupport(DefaultProductSalesQuery query) {
            this.query = query;
        }
        ...
        @Override
        public ProductSalesQuery build() {
            return this.query;
        }
    }
}
