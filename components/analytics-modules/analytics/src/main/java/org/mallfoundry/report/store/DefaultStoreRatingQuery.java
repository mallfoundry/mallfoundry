...
@Getter
@Setter
public class DefaultStoreRatingQuery implements StoreRatingQuery {
    ...
    protected abstract static class BuilderSupport implements Builder {
        ...
        private final DefaultStoreRatingQuery query;

        protected BuilderSupport(DefaultStoreRatingQuery query) {
            this.query = query;
        }
