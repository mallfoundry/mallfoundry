...
public class DefaultGeographyService implements GeographyService {
    ...
    public DefaultGeographyService(CountryRepository countryRepository,
    ...
    @Override
    public GeographyQuery createQuery() {
        return new DefaultGeographyQuery();
    }
    ...
    @Override
    public List<Country> getCountries(GeographyQuery query) {
        return this.countryRepository.findAll();
    }

    @Override
    public List<Region> getRegions(GeographyQuery query) {
        return this.regionRepository.findAllByCountryId(query.getCountryId());
    }

    @Override
    public List<Province> getProvinces(GeographyQuery query) {
        return this.provinceRepository.findAllByCountryId(query.getCountryId());
    }

    @Override
    public List<City> getCities(GeographyQuery query) {
        return this.cityRepository.findAllByProvinceId(query.getProvinceId());
    }

    @Override
    public List<County> getCounties(GeographyQuery query) {
