...
public interface GeographyService {
    ...
    List<Country> getCountries(GeographyQuery query);

    List<Region> getRegions(GeographyQuery query);

    List<Province> getProvinces(GeographyQuery query);

    List<City> getCities(GeographyQuery query);

    List<County> getCounties(GeographyQuery query);
