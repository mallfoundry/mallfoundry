...
public class DelegatingJpaStoreAddressRepository implements StoreAddressRepository {

    private final JpaStoreAddressRepository repository;

    public DelegatingJpaStoreAddressRepository(JpaStoreAddressRepository repository) {
