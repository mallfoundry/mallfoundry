...
public class DefaultTimeDimensionManager implements TimeDimensionManager {

    private final TimeDimensionRepository timeDimensionRepository;

    public DefaultTimeDimensionManager(TimeDimensionRepository timeDimensionRepository) {
    ...
    @Override
    public TimeDimension saveTimeDimension(TimeDimension timeDimension) {
        return this.timeDimensionRepository.save(timeDimension);
    }
}
