...
public class DefaultDateDimensionManager implements DateDimensionManager {

    private final DateDimensionRepository dateDimensionRepository;

    public DefaultDateDimensionManager(DateDimensionRepository dateDimensionRepository) {
