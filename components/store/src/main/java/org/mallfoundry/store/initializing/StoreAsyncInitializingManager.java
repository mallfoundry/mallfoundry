...
public class StoreAsyncInitializingManager implements StoreInitializingManager {

    private final StoreAsyncInitializingExecutor initializingExecutor;

    public StoreAsyncInitializingManager(StoreAsyncInitializingExecutor initializingExecutor) {
        this.initializingExecutor = initializingExecutor;
    }
    ...
    public StoreInitializing initializeStore(Store store) {
        ...
        while (Objects.isNull(nullableInitializing)) {
            nullableInitializing = this.initializingExecutor.getStoreInitializing(store.toId());
        }
