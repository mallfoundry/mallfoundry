...
public interface FollowingStoreQuery extends Query, ObjectBuilder.ToBuilder<FollowingStoreQuery.Builder> {
    ...
    interface Builder extends QueryBuilder<FollowingStoreQuery, Builder> {
