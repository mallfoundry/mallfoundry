...
package com.mallfoundry.catalog.infrastructure.persistence.mybatis.category;
...
import com.mallfoundry.keygen.PrimaryKeyGenerator;
...
public class ProductCategoryRepositoryMybatis implements ProductCategoryRepository {
    ...
    @Override
    public void add(List<ProductCategory> categories) {
